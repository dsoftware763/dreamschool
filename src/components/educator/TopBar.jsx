          ...
          >
            ...
            <div className="boxofit">
              <h6 className="dropdown-header">
                <div className="row">
                  <div className="col-7">Notifications</div>
                  <div className="col-5">
              ...
              <a className="dropdown-item d-flex align-items-center" href="#">
                ...
                <div>
                  <span className="titleofnot">
                    Enrollment Application Accepted
                  </span>
                  <div className="descofnot">Emily’s Dreamschool</div>
                </div>
              ...
              <a
                className="dropdown-item d-flex align-items-center clicked"
                href="#"
              >
                <div className="mr-3">
                  <div className="">
